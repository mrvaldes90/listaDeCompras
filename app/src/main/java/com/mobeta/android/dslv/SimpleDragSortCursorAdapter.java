...
import soft.mvaldes.listadecompras.R;
...
public class SimpleDragSortCursorAdapter extends ResourceDragSortCursorAdapter {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (v != null) {
                ...
                if (!bound) {
                    String text="";
                    Log.d("Info","1");
                    if (mOriginalFrom[i]=="addedOn") {
                        long time = cursor.getLong(cursor.getColumnIndex("addedOn"));
                        Log.d("Info",String.valueOf(time));
                    ...
                    if (v instanceof CheckBox) {
                        Log.d("Info", "Instance of checkbox");
                        v.setTag(cursor.getLong(cursor.getColumnIndex("Id")));
    ...
    private void setViewCheckBox(CheckBox v, String value) {
        ...
        if ((value.trim().equals("") || value.trim().equals("0")) || value.trim().equals("false"))
            v.setChecked(false);
        else {
            v.setChecked(true);
            Log.d("Info", "Checkbox value setted: " + v.isChecked());
        }
    }
